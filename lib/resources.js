 ...
 */
Resource.prototype.once = function (
  event,
  /**
...
function attachOperations() {
  ...
  function attachOperation(operation) {
    ...
    self.onRequest = self._client.onRequest;
    self.onResponse = self._client.onResponse;
    self.onError = self._client.onError;
    ...
    function callSwagger(/* args..., callback */) {
      ...
      if (self.onRequest) self.onRequest(self._resource, operation, args);
